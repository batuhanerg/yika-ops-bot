...
FRIENDLY_FIELD_MAP: dict[str, str] = {
    ...
    "tag_clean_to_red_timeout": "Tag clean-to-red timeout değeri kaç saniye?",
    ...
    "clean_hygiene_time": "Clean hygiene time değeri kaç saniye?",
    "hp_alert_time": "HP alert time değeri kaç saniye?",
    "hand_hygiene_time": "Hand hygiene time değeri kaç saniye?",
    "hand_hygiene_interval": "Hand hygiene interval (dashboard) değeri ne?",
    "hand_hygiene_type": "Hand hygiene type ne?",
